...
| <a name="input_application_success_feedback_role_arn"></a> [application\_success\_feedback\_role\_arn](#input\_application\_success\_feedback\_role\_arn) | IAM role permitted to receive success feedback for this topic | `string` | `null` | no |
...
| <a name="input_content_based_deduplication"></a> [content\_based\_deduplication](#input\_content\_based\_deduplication) | Enables content-based deduplication for FIFO topics | `string` | `null` | no |
...
| <a name="output_name"></a> [name](#output\_name) | The ARN of the SNS topic |
